			...
			<template #cell(actions)="row">
				<div class="d-flex align-items-center">
					...
					<b-dropdown toggle-class="p-0 bg-transparent text-dark border-0" toggle-tag="div" no-caret right>
						...
						<b-dropdown-item link-class="py-2 d-flex align-items-center" @click="editStudent({ ...row.item })">
						...
						<b-dropdown-item link-class="py-2 d-flex align-items-center text-danger" @click="showDeleteStudent({ ...row.item })">
...
export default {
	...
	methods: {
		...
		editStudent(student) {
			this.$store.commit("Student/setOne", student);
			this.$bvModal.show("studentForm");
		},

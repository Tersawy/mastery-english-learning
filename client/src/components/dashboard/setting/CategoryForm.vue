<template>
	<b-modal id="categoryForm" @hidden="resetModal" hide-footer @ok="handleSave" centered @show="modalIsShown">
		...
		<template #default="{ ok }">
			<b-form @submit.prevent="handleSave">
				...
				<b-form-group label="Category Name" label-for="name">
					<b-form-input id="name" v-model="category.name" ref="nameInput"></b-form-input>
